        ...
        <tbody>
        {
          listaCompras.map(item =>(
            <tr key={item.id}>
              ...
              <td>{item.price}</td>
              <td>
                <button className="btn btn-oulinr-primary" onClick={() => disminuirCantidad(item.id)}>-</button>
                <button className="btn btn-primary">{item.cantidad}</button>
                <button className="btn btn-oulinr-primary" onClick={() => aumentarCantidad(item.id)}>+</button>
              </td>
